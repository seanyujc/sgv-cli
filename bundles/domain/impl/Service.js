...
var Service = /** @class */ (function (_super) {
        ...
        fs.readdir(this.templatePath, function (err, files) {
            ...
            files.forEach(function (fileName, index, array) {
                ...
                fs.readFile(pathName, function (error, data) {
                    ...
                    var basePath = path.join(_super.prototype.getCurrentDir.call(_this), "src/app/core/services");
    ...
    Service.prototype.addFactoryFun = function () {
        var _this = this;
        var basePath = path.join(_super.prototype.getCurrentDir.call(this), "src/app/core");
        ...
        _super.prototype.addContentToFile.call(this, basePath, fileName, config_1.SERVICE.ORIGINAL, config_1.SERVICE.IMPORT_ANCHOR, addImportContent, function (err) {
            ...
            _super.prototype.addContentToFile.call(_this, basePath, fileName, config_1.SERVICE.ORIGINAL, config_1.SERVICE.FACTORY_ANCHOR, addFacContent, function (err) {
                if (err) {
                    winston.error(err.message);
                    return;
                }
    ...
    Service.prototype.removeFiles = function () {
        var _this = this;
        var basePath = path.join(_super.prototype.getCurrentDir.call(this), "src/app/core/services", this.name + ".serv.ts");
    ...
    Service.prototype.deleteFactoryFun = function () {
        ...
        var basePath = path.join(_super.prototype.getCurrentDir.call(this), "src/app/core");
        var fileName = "factory.serv.ts";
        var pattern = _super.prototype.replaceKeyword.call(this, config_1.SERVICE.FACTORY_FUNCTION_PATTERN, this.name) + _super.prototype.endl.call(this);
        _super.prototype.deleteContentFromFile.call(this, basePath, fileName, pattern, function (err) {
            ...
            pattern = _super.prototype.replaceKeyword.call(_this, config_1.SERVICE.IMPORT_PATTERN, _this.name) + _super.prototype.endl.call(_this);
            _super.prototype.deleteContentFromFile.call(_this, basePath, fileName, pattern, function (err) {
                if (err && err.name === "without") {
                    winston.error("Without config option in factory file!");
                    return;
                }
    ...
    Service.prototype.addServiceFun = function () {
        var _this = this;
        var basePath = path.join(_super.prototype.getCurrentDir.call(this), "src/app/core/services");
        ...
        _super.prototype.addContentToFile.call(this, basePath, fileName, "", config_1.SERVICE.INTERFACE_ANCHOR, addIFContent, function (err) {
            ...
            _super.prototype.addContentToFile.call(_this, basePath, fileName, "", config_1.SERVICE.FUNCTION_ANCHOR, addFunContent, function (err) {
                if (err) {
                    winston.error(err.message);
                    return;
                }
