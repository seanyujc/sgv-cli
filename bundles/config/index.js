...
exports.PAGE = {
    ...
    ROUTER_CONFIG_CONTENT: '{ path: "/<%= snakeKeyword%>", name: "<%= keyword%>", component: component: () => import("./pages/<%= snakeKeyword%>/<%= snakeKeyword%>.vue") },',
    ROUTER_CONFIG_PATTERN: '[\\t ]*{ path: "/<%= snakeKeyword%>", name: "<%= keyword%>", component: component: () => import\\("./pages/<%= snakeKeyword%>/<%= snakeKeyword%>.vue"\\) \\},',
};
exports.COMP = {
    FACTORY_ANCHOR: "// SGV-BUILD-COMP-FAC # NOT DELETE",
    FACTORY_CONTENT: 'Vue.component("<%= keyword%>", import("./<%= kebabKeyword%>/<%= kebabKeyword%>.vue"));',
    FACTORY_PATTERN: 'Vue\\.component\\("<%= keyword%>", import\\("./<%= kebabKeyword%>/<%= kebabKeyword%>.vue"\\)\\);',
};
exports.SERVICE = {
