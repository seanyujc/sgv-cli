...
exports.COMP = {
    ...
    FACTORY_CONTENT: 'Vue.component("<%= keyword%>", require("./<%= kebabKeyword%>/<%= kebabKeyword%>.vue").default);',
    FACTORY_PATTERN: 'Vue\\.component\\("<%= keyword%>", require\\("./<%= kebabKeyword%>/<%= kebabKeyword%>.vue"\\)\\.default\\);',
};
exports.SERVICE = {
